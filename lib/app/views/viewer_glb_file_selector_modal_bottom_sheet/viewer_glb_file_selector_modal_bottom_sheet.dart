...
void showViewerGlbFileSelectorModalBottomSheet(
  ...
  showModalBottomSheet<void>(
    ...
    builder: (context) => ViewerGlbFileSelectorModalBottomSheet(
      productId: productId,
      onTapTile: onTapTile,
    ),
  );
...
class ViewerGlbFileSelectorModalBottomSheet extends HookConsumerWidget {
  ViewerGlbFileSelectorModalBottomSheet({
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final viewModel = ref.watch(
      viewerGlbFileSelectorModalBottomSheetViewModelProvider(productId),
    );
